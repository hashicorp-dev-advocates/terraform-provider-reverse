...
// StringResource defines the resource implementation.
	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			"input": schema.StringAttribute{
				MarkdownDescription: "Input string to be reversed",
				Required:            true,
			},
			"result": schema.StringAttribute{
				MarkdownDescription: "Reversed string",
				Computed:            true,
			},
		},
	}
...
func (r *StringResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
